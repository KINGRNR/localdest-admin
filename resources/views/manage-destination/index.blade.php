...
<body id="kt_body" class="">
                                    ...
                                    <table
                                        ...
                                        <thead>
                                            ...
                                            <tr
                                                ...
                                                <th class="min-w-100px">Destination Title</th>

                                                <th class="min-w-100px">Destination Desc</th>
                                                <th class="min-w-100px">Destination By</th>
    ...
    @include('manage-destination.script')
